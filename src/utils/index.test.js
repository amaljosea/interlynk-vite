...
describe('validateCpe', () => {
  test('valid CPE should return true', () => {
    const validCpe =
      'cpe:2.3:h:cisco:adaptive_security_appliance:9.1.1.7:*:*:*:*:*:*:*'
  ...
  test('ISSUE-1409 CPE should be accepted', () => {
    ...
    const validCpeBaseCase =
      'cpe:2.3::dell:emc_omimssc_for_scvmm:7.2.1:*:*:*:*:*:*:*'
  ...
  test('ISSUE-1533 CPE should not have more than 12 parts', () => {
    const invalidCPE =
      'cpe:2.3:a:advanced_ajax_page_loader_project:advanced_ajax_page_loader:1.0.0:*:*:*:*:wordpress:*:*:*:*:*:*:*:*'
    expect(validateCpe(invalidCPE)).toBe(false)
  })
