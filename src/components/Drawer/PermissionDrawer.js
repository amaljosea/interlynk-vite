              ...
              {orgManagement
                ...
                .map((item, index) => (
                  <Checkbox
                    ...
                    isReadOnly={readOnly}
                    onChange={(e) => onCheckParent(e, item.category, orgManagement)}
                  >
                    {item.name}
                  </Checkbox>
                ))}
                ...
                {orgManagement
                  ...
                  .map((item, index) => (
                    <Checkbox
                      ...
                      isReadOnly={readOnly}
                      onChange={(e) => onCheckChild(e, item.category, index, checkedOrgManage)}
                    >
                      {item.name}
                    </Checkbox>
                  ))}
              ...
              {groupManagement
                ...
                .map((item, index) => (
                  <Checkbox
                    ...
                    isReadOnly={readOnly}
                    onChange={(e) => onCheckParent(e, item.category, groupManagement)}
                  >
                    {item.name}
                  </Checkbox>
                ))}
                ...
                {groupManagement
                  ...
                  .map((item, index) => (
                    <Checkbox
                      ...
                      isReadOnly={readOnly}
                      onChange={(e) => onCheckChild(e, item.category, index, checkedGroupManage)}
                    >
                      {item.name}
                    </Checkbox>
                  ))}
              ...
              {prodManagement
                ...
                .map((item, index) => (
                  <Checkbox
                    ...
                    isReadOnly={readOnly}
                    onChange={(e) => onCheckParent(e, item.category, prodManagement)}
                  >
                    {item.name}
                  </Checkbox>
                ))}
                ...
                {prodManagement
                  ...
                  .map((item, index) => (
                    <Checkbox
                      ...
                      isReadOnly={readOnly}
                      onChange={(e) => onCheckChild(e, item.category, index, checkedProdManage)}
                    >
                      {item.name}
                    </Checkbox>
                  ))}
              ...
              {sbomManagement
                ...
                .map((item, index) => (
                  <Checkbox
                    ...
                    isReadOnly={readOnly}
                    onChange={(e) => onCheckParent(e, item.category, sbomManagement)}
                  >
                    {item.name}
                  </Checkbox>
                ))}
                ...
                {sbomManagement
                  ...
                  .map((item, index) => (
                    <Checkbox
                      ...
                      isReadOnly={readOnly}
                      onChange={(e) => onCheckChild(e, item.category, index, checkedSbomManage)}
                    >
                      {item.name}
                    </Checkbox>
                  ))}
              ...
              {userManagement
                ...
                .map((item, index) => (
                  <Checkbox
                    ...
                    isReadOnly={readOnly}
                    onChange={(e) => onCheckParent(e, item.category, userManagement)}
                  >
                    {item.name}
                  </Checkbox>
                ))}
                ...
                {userManagement
                  ...
                  .map((item, index) => (
                    <Checkbox
                      ...
                      isReadOnly={readOnly}
                      onChange={(e) => onCheckChild(e, item.category, index, checkedUserManage)}
                    >
                      {item.name}
                    </Checkbox>
                  ))}
              ...
              {vulnManagement
                ...
                .map((item, index) => (
                  <Checkbox
                    ...
                    isReadOnly={readOnly}
                    onChange={(e) => onCheckParent(e, item.category, vulnManagement)}
                  >
                    {item.name}
                  </Checkbox>
                ))}
                ...
                {vulnManagement
                  ...
                  .map((item, index) => (
                    <Checkbox
                      ...
                      isReadOnly={readOnly}
                      onChange={(e) => onCheckChild(e, item.category, index, checkedVulnManage)}
                    >
                      {item.name}
                    </Checkbox>
                  ))}
